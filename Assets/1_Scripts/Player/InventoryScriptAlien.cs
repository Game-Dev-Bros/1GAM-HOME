...
namespace Weapons
{
    public class InventoryScriptAlien : MonoBehaviour
    {
        ...
        private SkinnedMeshRenderer pistolMesh, machinegunMesh, rocketlauncherMesh;
        ...
        void InitWeapons()
        {
            ...
            pistolMesh = pistolPrefab.GetComponent<SkinnedMeshRenderer>();

            machinegunScript = machinegunPrefab.GetComponent<WeaponScript>();
            machinegunMesh = machinegunPrefab.GetComponent<SkinnedMeshRenderer>();

            rocketlauncherScript = rocketlauncherPrefab.GetComponent<WeaponScript>();
            rocketlauncherMesh = rocketlauncherPrefab.GetComponent<SkinnedMeshRenderer>();
        }
